...
<head>
    <title>Editar Cliente Particular</title>
    <meta charset="utf-8" />
...
<body>
    <div class="container">
        <div class="modal fade" id="editclienteparticularModal" tabindex="-1"
            aria-labelledby="editclienteparticularModalLabel" aria-hidden="true" data-bs-backdrop="static"
            data-bs-keyboard="false">
            <div class="modal-dialog modal-dialog-scrollable modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editclienteparticularModalLabel">Editar Cliente Particular</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">

                        <form id="editParticularForm" action="" method="POST" enctype="multipart/form-data">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var editclienteparticularModal = document.getElementById('editclienteparticularModal');

            // Crear el campo oculto para contactos eliminados
            const form = document.getElementById('editParticularForm');
            ...
            if (editclienteparticularModal) {
                editclienteparticularModal.addEventListener('show.bs.modal', function(event) {
                    var form = document.getElementById('editParticularForm');
                ...
                console.error('Modal no encontrado: editclienteparticularModal');
            }
        });
    </script>
</body>
