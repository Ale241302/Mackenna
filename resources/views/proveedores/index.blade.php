...
@section('content')
    <div class="container">
        ...
        @if (in_array(69, $permisosUsuario))
            <div class="d-flex justify-content-end mb-3">
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createProveedorModal">+
                    Crear
                    Proveedor</a>
            </div>
        @endif
        <form id="search-form" action="{{ route('proveedores.index') }}" method="GET" class="mb-3">
            <br />
                                ...
                                <div class="d-flex align-items-center">
                                    @if (in_array(68, $permisosUsuario))
                                        <a href="#" class="btn btn-warning me-2"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#verproveedorModal"
                                            data-id="{{ $cliente->id }}" data-name="{{ $cliente->name }}"
                                            data-cuenta_contable="{{ $cliente->cuenta_contable }}"
                                            data-estado="{{ $cliente->estado }}" data-cliente="{{ $cliente->cliente }}"
                                    ...
                                    @endif
                                    @if (in_array(70, $permisosUsuario))
                                        <a href="#" class="btn btn-warning me-2"
                                            ...
                                            data-id="{{ $cliente->id }}" data-name="{{ $cliente->name }}"
                                            data-cuenta_contable="{{ $cliente->cuenta_contable }}"
                                            data-estado="{{ $cliente->estado }}" data-clientes="{{ $cliente->cliente }}"
                                            data-tipo_documento="{{ $cliente->tipo_documento }}"
                                            data-numero_documento="{{ $cliente->numero_documento }}"
                                            data-municipio="{{ $cliente->municipio }}" data-paisn="{{ $cliente->paisn }}"
                                            data-fachadoc="{{ $cliente->fachadoc }}"
