...
<body>
    <div class="container">
        <div class="modal fade" id="editTipoCarnetModal" tabindex="-1" aria-labelledby="editTipoCarnetModalLabel"
            aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editTipoCarnetModalLabel">Editar Tipo</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="edittipocarnetForm" action="{{ route('tipocarnet.update', 'tipo_carnet_id') }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var editTipoCarnetModal = document.getElementById('editTipoCarnetModal');

            editTipoCarnetModal.addEventListener('show.bs.modal', function(event) {
                ...
                var form = document.getElementById('edittipocarnetForm');
