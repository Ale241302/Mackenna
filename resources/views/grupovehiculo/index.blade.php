...
@section('content')
    <div class="container">
        <h1 class="flex-grow-1 text-center mb-0">Tipo Vehículos</h1>
        <br />

        <!-- Habilita el botón de crear solo si el usuario tiene el permiso correspondiente -->
        @if (in_array(57, $permisosUsuario))
            <div class="d-flex justify-content-end">
                <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#createGrupovehiculoModal">+Crear Tipo</a>
            </div>
        @endif
        <form id="search-form" action="{{ route('grupovehiculo.index') }}" method="GET" class="mb-3">
            <br />
        ...
        <table class="table">
            ...
            <tbody>
                @foreach ($grupovehiculos as $tipo)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                @if (in_array(58, $permisosUsuario))
                                    <a href="#" class="btn btn-warning me-2"
                                        style="border-color: white; background-color: white; color: #1814F3; font-size: 20px; "
                                        data-bs-toggle="modal" data-bs-target="#editGrupovehiculoModal"
    ...
    @include('grupovehiculo.create')
    @include('grupovehiculo.edit')
