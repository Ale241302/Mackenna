                            ...
                            <div class="d-flex align-items-center">
                                ...
                                @if (in_array(23, $permisosUsuario))
                                    ...
                                    <a href="#" class="btn btn-warning me-2"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#editsucursalModal"
                                        data-id="{{ $sucursal->id }}" data-name="{{ $sucursal->nombre }}"
                                        data-direccion="{{ $sucursal->direccion }}" data-ciudad="{{ $sucursal->ciudad }}"
                                        data-tipo="{{ $sucursal->tipo_sucursal }}">
