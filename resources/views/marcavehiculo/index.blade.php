...
@section('content')
    <div class="container">
        ...
        @endif
        <form id="search-form" action="{{ route('marcavehiculo.index') }}" method="GET" class="mb-3">
            <br />
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                @if (in_array(3, $permisosUsuario))
                                    ...
                                    <a href="#" class="btn btn-warning me-2"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#editMarcavehiculoModal"
